  ...
  // Swiper effect 'cards', e LIGHTBOX com swipe-down para fechar
  // e pinch-zoom (pinça) no iOS.
  ...
  (async function(){
    ...
    const total = 59;
    const BASES = ['/public/images/timeline', '/images/timeline'];
    ...
    function createLightboxDOM(){
      ...
      dialog.addEventListener('gesturechange', (e)=>{
        ...
        lb.img.style.transform = `translate3d(0,0,0) scale(${pinch.scale})`;
        e.preventDefault();
      });
